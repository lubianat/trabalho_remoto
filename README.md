...
Num ambiente de trabalho remoto regular, de longo prazo, esses momentos sociais intencionais podem tomar uma variedade de formas. Segue abaixo uma lista de sugestões de eventos com uma breve descrição (a maior parte sugestões da [GitLab][18] e da [Zapier][19]):

- **Jogos**: vários jogos são apropriados para um happy hour do trabalho, são divertidos, com uma curva de aprendizado suave e funcionam bem à distância. Recomendações: [Gartic](), [StopOps](), [jogos de tabuleiro online](https://pt.boardgamearena.com/), qualquer jogo .io (e.g. agar.io), o bom e velho xadrez(https://lichess.org/) ou buraco(https://buracoon.com.br/). Uma alternativa paga é qualquer jogo da Jackbox Games, com menção especial pra Drawful(https://www.jackboxgames.com/). E se for um grupo mais hardcore, dá pra fazer as reuniões de trabalho em [Minecraft](https://medium.com/@H2cents/want-to-have-a-conference-in-minecraft-e4bc3b0c5c42) ou [Red Dead Redemption 2](https://twitter.com/vivschwarz/status/1261575801008504832).
